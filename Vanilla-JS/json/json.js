...
const table =window.document.getElementById('data-table')
for(let studentData of StudentDatabase){

  let tr=``;
  tr +=`<tr>`
  tr +=`<td>` + studentData.student_id +   `</td>`
  tr +=`<td>` + studentData.student_name +   `</td>`
  tr +=`<td>` + studentData.department +   `</td>`
  tr +=`<td>` + studentData.organization +   `</td>`
  tr +=`<td>` + studentData.cgpa +   `</td>`
  tr +=`</tr>`
